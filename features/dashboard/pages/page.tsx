...
import {
  DashboardFilters,
  MatchFilterTab,
} from "@/features/dashboard/components/DashboardFilters";
import {
  RefreshCw,
  Flame,
  AlertCircle,
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-slate-300 mt-2 max-w-xl font-medium drop-shadow-sm">
              Track live scores, match timelines, possession statistics, and fan
              chat as fixtures unfold in real-time.
            </p>
          </div>
